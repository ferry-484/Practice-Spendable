...
//       where: { active: 1, createdBy: this.state.filter.createdBy }
//     })
//       .then(res => res.json())
//       .then(res => {
//         this.setState({
//           loading: false,
//           userData: res.data.allPaymentRequests.PaymentRequests.map(item => {
//             return {
//               id: item.id,
//                //name: item.itemName,
//               createdBy:
...
//                       : "")
//                   : "",
//                   amount: item.requestedAmount !== undefined &&
//                   item.requestedAmount !== null
//                     ? `$${item.requestedAmount}`
//                     : "",
...
//               onChange={(e, v) => this.handleFilterAutocomplete(e, v)}
//               getOptionLabel={option =>
//                 option && option.createdBy ? option.createdBy : ""
//               }
//               // style={{ width: 300 }}
//               renderInput={params => (
//                 <TextField
...
//               onChange={(e, v) => this.handleFilterAutocomplete(e, v)}
//               getOptionLabel={option =>
//                 option && option.createdFor ? option.createdFor : ""
//               }
//               // style={{ width: 300 }}
//               renderInput={params => (
//                 <TextField
...
//               onChange={(e, v) => this.handleFilterAutocomplete(e, v)}
//               getOptionLabel={option =>
//                 option && option.storeName ? option.storeName : ""
//               }
//               // style={{ width: 300 }}
//               renderInput={params => (
//                 <TextField
...
//               onChange={(e, v) => this.handleFilterAutocomplete(e, v)}
//               getOptionLabel={option =>
//                 option && option.addedOn ? option.addedOn : ""
//               }
//               // style={{ width: 300 }}
//               renderInput={params => (
//                 <TextField
